...
void CDigitShowBasicView::ShowData()
{
    ...
    m_Vout00.Format("%11.0f",ctx->ai_raw[0]);
    m_Vout01.Format("%11.0f",ctx->ai_raw[1]);
    m_Vout02.Format("%11.0f",ctx->ai_raw[2]);
    m_Vout03.Format("%11.0f",ctx->ai_raw[3]);
    m_Vout04.Format("%11.0f",ctx->ai_raw[4]);
    m_Vout05.Format("%11.0f",ctx->ai_raw[5]);
    m_Vout06.Format("%11.0f",ctx->ai_raw[6]);
    m_Vout07.Format("%11.0f",ctx->ai_raw[7]);
    m_Vout08.Format("%11.0f",ctx->ai_raw[8]);
    m_Vout09.Format("%11.0f",ctx->ai_raw[9]);
    m_Vout10.Format("%11.0f",ctx->ai_raw[10]);
    m_Vout11.Format("%11.0f",ctx->ai_raw[11]);
    m_Vout12.Format("%11.0f",ctx->ai_raw[12]);
    m_Vout13.Format("%11.0f",ctx->ai_raw[13]);
    m_Vout14.Format("%11.0f",ctx->ai_raw[14]);
    m_Vout15.Format("%11.0f",ctx->ai_raw[15]);
